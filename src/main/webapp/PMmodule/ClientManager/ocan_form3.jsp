...
$('document').ready(function(){
	$('#born_in_canada').change(function(){
		if($(this).val()=='FALSE'){
			$("#tr_born_in_canada").css("display", "")
		}else{
			$("#tr_born_in_canada").css("display", "none")
		}
	});
	if($('#born_in_canada').val()=='FALSE'){
		$("#tr_born_in_canada").css("display", "");
	}
});
...
<%} %>
	...
	<table style="margin-left:auto;margin-right:auto;background-color:#f0f0f0;border-collapse:collapse">
		...
		<tr>
			<td class="genericTableHeader">Reason for OCAN (Select One)</td>
			<td class="genericTableData">
				<select name="reasonForAssessment" id="reasonForAssessment" class="{validate: {required:true}}">
					<option value="">Select an answer</option>
					<%
						for (org.oscarehr.common.model.OcanFormOption option : OcanForm.getOcanFormOptions(ocanVersionStr, "Reason for OCAN"))
						{
							String selected="";
...
<% if("FULL".equals(ocanType)) { %>
		...
		<tr>
			<td class="genericTableHeader">Was Consumer Self-Assessment Completed? (Select One)</td>
			<td class="genericTableData">
	...
	<% } %>					
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="clientDOBType" id="clientDOBType" >
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "clientDOBType", OcanForm.getOcanFormOptions(ocanVersionStr, "client DOB Type"),prepopulationLevel)%>
				</select>	
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="familyDoctor">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "familyDoctor", OcanForm.getOcanFormOptions(ocanVersionStr, "Doctor Psychiatrist"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="psychiatrist">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "psychiatrist", OcanForm.getOcanFormOptions(ocanVersionStr, "Doctor Psychiatrist"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="otherContact" id="otherContact" >
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "otherContact", OcanForm.getOcanFormOptions(ocanVersionStr, "Other Contacts Agency"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="otherAgency" id="otherAgency" >
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "otherAgency", OcanForm.getOcanFormOptions(ocanVersionStr, "Other Contacts Agency"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">Consumer Capacity</td>
		</tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="power_attorney_property" id="power_attorney_property">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "power_attorney_property", OcanForm.getOcanFormOptions(ocanVersionStr, "Client Capacity"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>	
		<tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="power_attorney_personal_care" id="power_attorney_personal_care">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "power_attorney_personal_care", OcanForm.getOcanFormOptions(ocanVersionStr, "Client Capacity"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>			
		<tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="court_appointed_guardian" id="court_appointed_guardian">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "court_appointed_guardian", OcanForm.getOcanFormOptions(ocanVersionStr, "Client Capacity"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>	
		<tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="financeProperty" id="financeProperty">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "financeProperty", OcanForm.getOcanFormOptions(ocanVersionStr, "Areas Of Concern"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>		
		<tr>
			...
			<td class="genericTableData">
				<select name="treatmentDecisions" id="treatmentDecisions">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "treatmentDecisions", OcanForm.getOcanFormOptions(ocanVersionStr, "Areas Of Concern"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="ageTypeOnsetMental" id="ageTypeOnsetMental">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "ageTypeOnsetMental", OcanForm.getOcanFormOptions(ocanVersionStr, "Age of Onset"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>	
		<tr>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="ageTypeHospitalization" id="ageTypeHospitalization">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "ageTypeHospitalization", OcanForm.getOcanFormOptions(ocanVersionStr, "Age of Onset"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>	
		<tr>
		...
		<tr>
			<td class="genericTableHeader">Racial or ethnic group - Other</td>
			<td class="genericTableData">
				<%=OcanForm.renderAsTextField(ocanStaffForm.getId(),"cultureother",128, prepopulationLevel)%>
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">What is your Sexual Orientation? (Select One)</td>
			<td class="genericTableData">
				<select name="sex_orientation" id="sex_orientation" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "sex_orientation", OcanForm.getOcanFormOptions(ocanVersionStr, "Sexual Orientation"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Citizenship Status (select one)</td>
			<td class="genericTableData">
				<select name="citizenship_status">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "citizenship_status", OcanForm.getOcanFormOptions(ocanVersionStr, "Citizenship Status"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		
		<tr>
			<td class="genericTableHeader">Were you born in Canada?</td>
			<td class="genericTableData">
				<select name="born_in_canada" id="born_in_canada" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "born_in_canada", OcanForm.getOcanFormOptions(ocanVersionStr, "common_options_yes_no"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		
		<tr id='tr_born_in_canada' style="display: none;">
			<td class="genericTableHeader">What year did you arrive in Canada?</td>
			<td class="genericTableData">
				<%  input = OcanForm.renderAsTextField(ocanStaffForm.getId(),"year_arrived_in_canada",4,prepopulationLevel);
				input = input.substring(0,input.length()-2);
				input = input.concat(" class=\"{validate: {digitalNumber:true}}\"/> ");
				%>
				<%=input %>
...
<% if("FULL".equals(ocanType)) { %>						
		...
		<tr>
			<td class="genericTableHeader">Experience of Discrimination (Select all that apply)</td>
			<td class="genericTableData">
...
<% } %>		
		<tr>
			...
			<td class="genericTableHeader">What language would you feel most comfortable speaking in with your health care provider?</td>
			<td class="genericTableData">
				<select name="preferred_language" id="preferred_language" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "preferred_language", OcanForm.getOcanFormOptions(ocanVersionStr, "Language"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		
		<tr>
			<td class="genericTableHeader">What language would you feel most comfortable speaking in with your health care provider? - Other</td>
			<td class="genericTableData">
				<%=OcanForm.renderAsTextField(ocanStaffForm.getId(), "preferred_language_other", 128,prepopulationLevel)%>						
			</td>
		</tr>	
		...
		<tr>
			<td class="genericTableHeader">Language of Service Provision - Other</td>
			<td class="genericTableData">
				<%=OcanForm.renderAsTextField(ocanStaffForm.getId(), "language_service_provision_other", 128,prepopulationLevel)%>						
			</td>
		</tr>	
	 	
		<tr>
			<td class="genericTableHeader">What is your mother tongue? (Select One)</td>
			<td class="genericTableData">
				<select name="mother_tongue" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "mother_tongue", OcanForm.getOcanFormOptions(ocanVersionStr, "Language"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>	
		...
		<tr>
			<td class="genericTableHeader">Do you currently have any legal issues? (Select all that apply)</td>
			<td class="genericTableData">
				<%-- <select name="legal_issues" class="{validate: {required:true}}"> --%>
					<%=OcanForm.renderAsCheckBoxOptions(ocanStaffForm.getId(), "legal_issues", OcanForm.getOcanFormOptions(ocanVersionStr, "Legal Issues"),prepopulationLevel)%>
				<%-- </select> --%>					
			</td>
		</tr>
...
<% }  %>	
		<tr>
			<td class="genericTableHeader">Where do you live? (Select One)</td>
			<td class="genericTableData">
				<select name="1_where_live" id="1_where_live" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "1_where_live", OcanForm.getOcanFormOptions(ocanVersionStr, "Residence Type"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>		
		...
		<tr>
			<td class="genericTableHeader">Do you live with anyone - Other</td>
			<td class="genericTableData">
				<%=OcanForm.renderAsTextField(ocanStaffForm.getId(), "1_live_with_anyone_other", 128,prepopulationLevel)%>						
			</td>
		</tr>	
...
<% } %>
		...
		<tr>
			<td class="genericTableHeader">Are you currently in school? (Select One)</td>
			<td class="genericTableData">
				<select name="5_education_program_status" id="5_education_program_status" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "5_education_program_status", OcanForm.getOcanFormOptions(ocanVersionStr, "Education Program Status"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>		
		<tr>
...
<% if("FULL".equals(ocanType)) { %>
		...
		<tr>
			<td class="genericTableHeader">Medical Conditions? (Select all that apply) <br><br>
			This information is collected from a variety of sources, including self-report, and should not be used for diagnosis without being confirmed by a qualified diagnosing practitioner.
			</td>
			<td class="genericTableData">
...
<% if("FULL".equals(ocanType)) { %>
		...
		<tr>
			<td class="genericTableHeader">Symptoms (Select all that apply) <br><br>
			This information is collected from a variety of sources, including self-report, and should not be used for diagnosis without being confirmed by a qualified diagnosing practitioner
			</td>
			<td class="genericTableData">
	...
	<% } %>
		<tr>
			...
			<td class="genericTableData">
				<%=OcanForm.renderAsCheckBoxOptions(ocanStaffForm.getId(), "diagnostic_categories", OcanForm.getOcanFormOptions(ocanVersionStr, "Diagnostic Categories"),prepopulationLevel)%>						
			</td>
		</tr>
		
		<tr>
			<td class="genericTableHeader">Source of diagnosis (Select One)</td>
			<td class="genericTableData">
				<select name="source_diagnosis"  id="source_diagnosis">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "source_diagnosis", OcanForm.getOcanFormOptions(ocanVersionStr, "Diagnostic Source"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">Do you have any of the following disabilities? (Select all that apply)</td>
			<td class="genericTableData">
				<%=OcanForm.renderAsCheckBoxOptions(ocanStaffForm.getId(), "disabilities", OcanForm.getOcanFormOptions(ocanVersionStr, "Disabilities"),prepopulationLevel)%>						
			</td>
		</tr>
		
		<tr>
			<td class="genericTableHeader">Disabilities - Other</td>
			<td class="genericTableData">
				<%=OcanForm.renderAsTextField(ocanStaffForm.getId(), "disabilities_other", 128,prepopulationLevel)%>						
			</td>
		</tr>	
...
<% if("FULL".equals(ocanType)) { %>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="level_of_education" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "level_of_education", OcanForm.getOcanFormOptions(ocanVersionStr, "Education Level"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
	...
	<% } %>
		...
		<tr>
			...
			<td class="genericTableData">
				<select name="income_source_type" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "income_source_type", OcanForm.getOcanFormOptions(ocanVersionStr, "Income Source Type"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>
		...
		<tr>
			<td class="genericTableHeader">How many people does this income support?</td>
			<td class="genericTableData">
				<select name="people_income_support" class="{validate: {required:true}}">
					<%=OcanForm.renderAsSelectOptions(ocanStaffForm.getId(), "people_income_support", OcanForm.getOcanFormOptions(ocanVersionStr, "Income Support"),prepopulationLevel)%>
				</select>					
			</td>
		</tr>

		<%-- <tr>
			<td class="genericTableHeader">How many people does this income support? (Enter Persons)</td>
			<td class="genericTableData">
				<%=OcanForm.renderAsTextField(ocanStaffForm.getId(),"people_income_support_other",2,prepopulationLevel)%>
			</td>
		</tr> --%>
